        ...
        <div class="">
          <div class="relative mb-3">
            <div class="absolute flex flex-col top-0 right-0 p-3"><button
                ...
                </svg></button></div><img class="w-full" src="{{asset('files/slider_home01-2.83a17b30.jpg')}}"
              alt="Product title">
          </div>
        ...
        <div class="">
          <div class="relative mb-3">
            <div class="absolute flex flex-col top-0 right-0 p-3"><button
                ...
                </svg></button></div><img class="w-full" src="{{asset('files/slider_home01-3.7235d6ee.jpg')}}"
              alt="Product title">
          </div>
          <div class="flex-auto justify-evenly">
        ...
        <div class="">
          <div class="relative mb-3">
            <div class="absolute flex flex-col top-0 right-0 p-3"><button
                ...
                </svg></button></div><img class="w-full" src="{{asset('files/slider_home01-1.70ad19e6.jpg')}}"
              alt="Product title">
          </div>
          <div class="flex-auto justify-evenly">
        ...
        <div class="">
          <div class="relative mb-3">
            <div class="absolute flex flex-col top-0 right-0 p-3"><button
                ...
                </svg></button></div><img class="w-full" src="{{asset('files/slider_home01.3c0c889a.jpg')}}"
              alt="Product title">
          </div>
          <div class="flex-auto justify-evenly">
            <p class="text-xs font-bold">BOSSALINI FLY HOODIE - BLACK</p>
