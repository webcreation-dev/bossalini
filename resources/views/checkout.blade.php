                    ...
                    <div class="cart-item ">
                      <div class="cart-item__content">
                        ...
                        <div class="cart-item__info">
                          ...
                          <span class="cart-item__size-label"> Number: 36,5 </span>
                  ...
                  <fieldset class="cart-section__fieldset" name="shipping-country">
                    ...
                    <div class="cart-section__content">
                      <div class="field field-country">
                        <label for="shipping-country" class="field__label shipping-country__label">Country</label>
                        <select id="shipping-country" class="field__select js-country" name="country" data-action="countryCode" data-setregion-url="/en/customer/setregion">
                      ...
                      <div class="field field-region field-region--region-CA is-disabled">
                        <label for="region-CA" class="field__label">State</label>
                        <select id="region-CA" name="region" class="field__select js-country" disabled="" data-action="id">
                          <option value="">State</option>
                          <option value="391" data-region-code="AB"> Alberta </option>
                          <option value="392" data-region-code="BC"> British Columbia </option>
                          <option value="393" data-region-code="MB"> Manitoba </option>
                          <option value="394" data-region-code="NB"> New Brunswick </option>
                          <option value="395" data-region-code="NL"> Newfoundland and Labrador </option>
                          <option value="396" data-region-code="NS"> Nova Scotia </option>
                          <option value="509" data-region-code="ON"> Ontario </option>
                          <option value="397" data-region-code="PE"> Prince Edward Island </option>
                          <option value="398" data-region-code="QC"> Quebec </option>
                          <option value="399" data-region-code="SK"> Saskatchewan </option>
                        </select>
                      </div>
                      <div class="field field-region field-region--region-US is-disabled">
                        <label for="region-US" class="field__label">State</label>
                        <select id="region-US" name="region" class="field__select js-country" disabled="" data-action="id">
                          <option value="">State</option>
                          <option value="453" data-region-code="AL"> Alabama </option>
                          <option value="454" data-region-code="AK"> Alaska </option>
                          <option value="455" data-region-code="AZ"> Arizona </option>
                          <option value="456" data-region-code="AR"> Arkansas </option>
                          <option value="457" data-region-code="AE"> Armed Forces (Europe/Canada/Middle East/Africa) </option>
                          <option value="458" data-region-code="AA"> Armed Forces Americas (except Canada) </option>
                          <option value="459" data-region-code="AP"> Armed Forces Pacific </option>
                          <option value="460" data-region-code="CA"> California </option>
                          <option value="461" data-region-code="CO"> Colorado </option>
                          <option value="462" data-region-code="CT"> Connecticut </option>
                          <option value="463" data-region-code="DE"> Delaware </option>
                          <option value="464" data-region-code="DC"> District of Columbia </option>
                          <option value="465" data-region-code="FL"> Florida </option>
                          <option value="466" data-region-code="GA"> Georgia </option>
                          <option value="467" data-region-code="HI"> Hawaii </option>
                          <option value="468" data-region-code="ID"> Idaho </option>
                          <option value="469" data-region-code="IL"> Illinois </option>
                          <option value="470" data-region-code="IN"> Indiana </option>
                          <option value="471" data-region-code="IA"> Iowa </option>
                          <option value="472" data-region-code="KS"> Kansas </option>
                          <option value="473" data-region-code="KY"> Kentucky </option>
                          <option value="474" data-region-code="LA"> Louisiana </option>
                          <option value="475" data-region-code="ME"> Maine </option>
                          <option value="476" data-region-code="MD"> Maryland </option>
                          <option value="477" data-region-code="MA"> Massachusetts </option>
                          <option value="478" data-region-code="MI"> Michigan </option>
                          <option value="479" data-region-code="MN"> Minnesota </option>
                          <option value="480" data-region-code="MS"> Mississippi </option>
                          <option value="481" data-region-code="MO"> Missouri </option>
                          <option value="482" data-region-code="MT"> Montana </option>
                          <option value="483" data-region-code="NE"> Nebraska </option>
                          <option value="488" data-region-code="NV"> Nevada </option>
                          <option value="484" data-region-code="NH"> New Hampshire </option>
                          <option value="485" data-region-code="NJ"> New Jersey </option>
                          <option value="486" data-region-code="NM"> New Mexico </option>
                          <option value="487" data-region-code="NY"> New York </option>
                          <option value="489" data-region-code="NC"> North Carolina </option>
                          <option value="490" data-region-code="ND"> North Dakota </option>
                          <option value="491" data-region-code="OH"> Ohio </option>
                          <option value="492" data-region-code="OK"> Oklahoma </option>
                          <option value="493" data-region-code="OR"> Oregon </option>
                          <option value="494" data-region-code="PA"> Pennsylvania </option>
                          <option value="495" data-region-code="RI"> Rhode Island </option>
                          <option value="496" data-region-code="SC"> South Carolina </option>
                          <option value="497" data-region-code="SD"> South Dakota </option>
                          <option value="498" data-region-code="TN"> Tennessee </option>
                          <option value="499" data-region-code="TX"> Texas </option>
                          <option value="500" data-region-code="UT"> Utah </option>
                          <option value="502" data-region-code="VT"> Vermont </option>
                          <option value="504" data-region-code="VA"> Virginia </option>
                          <option value="501" data-region-code="WA"> Washington </option>
                          <option value="503" data-region-code="WV"> West Virginia </option>
                          <option value="505" data-region-code="WI"> Wisconsin </option>
                          <option value="506" data-region-code="WY"> Wyoming </option>
                        </select>
                      </div>
                    </div>
                  </fieldset>
                      ...
                      <div id="customer-login-step1" class="customer-login__step customer-login__step--one">
                        <div class="customer-login__field-group">
                          <div class="field ">
                            ...
                            <input id="email-address" name="emailAddress" class="field__input" type="email" value="" placeholder="E.g jane@company.com" pattern="^.{0,36}$" required="" autocomplete="email" wfd-id="id6" readonly="">
                          </div>
                          <div class="field field--btn" hidden="">
                            <button id="customer-continue-btn" type="button" class="btn btn--submit customer-login__btn" disabled="">
                              <span>Continue</span>
                            </button>
                          </div>
                        </div>
                  ...
                  <fieldset class="cart-section__fieldset cart-section__fieldset--shipping" id="shipping-address-section">
                    ...
                    <div class="cart-section__content customer-details__group">
                      <div class="field field-firstname ">
                        ...
                        <input id="shipping-first-name" name="firstName" type="text" class="field__input" value="" placeholder="E.g Jane" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,20}$" maxlength="20" required="" autocomplete="shipping given-name" wfd-id="id7">
                      </div>
                      <div class="field field-lastname ">
                        <label for="shipping-last-name" class="field__label"> Last name </label>
                        <input id="shipping-last-name" name="lastName" type="text" class="field__input" value="" placeholder="E.g Doe" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,20}$" maxlength="20" required="" autocomplete="shipping family-name" wfd-id="id8">
                      </div>
                      <div class="field field-address-line-2 ">
                        <label for="shipping-address-line-2" class="field__label"> Address </label>
                        <input id="shipping-address-line-2" name="addressLine2" type="text" class="field__input" value="" data-message="Maximum length of 30 characters allowed" placeholder="E.g Street 12" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,30}$" required="" autocomplete="shipping address-line1" wfd-id="id9">
                      </div>
                      ...
                      <div class="field field-postalcode ">
                        ...
                        <input id="shipping-postal-code" name="postalCode" type="text" class="field__input" value="" placeholder="E.g. 123 45" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,30}$" required="" autocomplete="shipping postal-code" wfd-id="id11">
                      </div>
                      <div class="field field-city ">
                        <label for="shipping-city" class="field__label"> City </label>
                        <input id="shipping-city" name="city" type="text" class="field__input" value="" placeholder="E.g Copenhagen" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,30}$" required="" autocomplete="shipping address-level2" wfd-id="id12">
                      </div>
                      <div class="field field-phone-number ">
                        <label for="shipping-phone-number" class="field__label"> Phone number </label>
                        <input id="shipping-phone-number" type="tel" name="phoneNumber" class="field__input" value="" placeholder="E.g. 08-12 345 678" required="" autocomplete="shipping tel" wfd-id="id13">
                      </div>
