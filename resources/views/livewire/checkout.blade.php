          ...
          <div class="cart-section__content">
            <div class="field field-country">
              <label for="shipping-country" class="field__label ">Country</label>
                <select class="js-example-basic-single field__select " name="country" id="countySel" style="width: 100%; border: 1px solid #000 !important; min-height: 5.5rem !important; padding: 3.5rem !important;">
            ...
            <div id="customer-login-step1" class="customer-login__step customer-login__step--one">
              <div class="customer-login__field-group">
                <div class="field ">
                  ...
                  <input id="email-address" name="email" class="field__input" type="email"  value="@if (Auth::check()) @if($addresses != [])  {{$addresses['email']}} @endif  @endif" placeholder="E.g jane@company.com" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,20}$" maxlength="20" required="" autocomplete="shipping given-name" wfd-id="id7">
                </div>
        ...
        <fieldset class="cart-section__fieldset cart-section__fieldset--shipping" id="shipping-address-section">
          ...
          <div class="cart-section__content customer-details__group">
            <div class="field field-firstname ">
              ...
              <input id="shipping-first-name" name="first_name" type="text" class="field__input" value="@if (Auth::check()) @if($addresses != []) {{$addresses['first_name']}} @endif @endif" placeholder="E.g Jane" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,20}$" maxlength="20" required="" autocomplete="shipping given-name" wfd-id="id7">
            </div>
            <div class="field field-lastname ">
              <label for="shipping-last-name" class="field__label"> Last name </label>
              <input id="shipping-last-name" name="last_name" type="text" class="field__input" value="@if (Auth::check()) @if($addresses != []) {{$addresses['last_name']}} @endif @endif" placeholder="E.g Doe" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,20}$" maxlength="20" required="" autocomplete="shipping family-name" wfd-id="id8">
            </div>
            <div class="field field-address-line-2 ">
              <label for="shipping-address-line-2" class="field__label"> Address </label>
              <input id="shipping-address-line-2" name="address" type="text" class="field__input" value="@if (Auth::check()) @if($addresses != []) {{$addresses['apartment']}} @endif @endif" data-message="Maximum length of 30 characters allowed" placeholder="E.g Street 12" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,30}$" required="" autocomplete="shipping address-line1" wfd-id="id9">
            </div>
            <div class="field field-postalcode ">
              <label for="shipping-postal-code" class="field__label"> Postal code </label>
              <input id="shipping-postal-code" name="zip_code" type="text" class="field__input" value="@if (Auth::check()) @if($addresses != []) {{$addresses['zip_code']}} @endif @endif" placeholder="E.g. 123 45" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,30}$" required="" autocomplete="shipping postal-code" wfd-id="id11">
            </div>
            <div class="field field-city ">
              <label for="shipping-city" class="field__label"> City </label>
              <input id="shipping-city" name="city" type="text" class="field__input" value="@if (Auth::check()) @if($addresses != []) {{$addresses['city']}} @endif @endif" placeholder="E.g Copenhagen" pattern="^[^\u0400-\u04FF\x08\u3000-\u303f\u3040-\u309f\u30a0-\u30ff\uff00-\uff9f\u4e00-\u9faf\u3400-\u4dbf\u3131-\u314e\u314f-\u3163\uac00-\ud7a3]{0,30}$" required="" autocomplete="shipping address-level2" wfd-id="id12">
            </div>
            <div class="field field-phone-number ">
              <label for="shipping-phone-number" class="field__label"> Phone number </label>
              <input id="shipping-phone-number" type="tel" name="phone" class="field__input" value="@if (Auth::check()) @if($addresses != []) {{$addresses['phone']}} @endif @endif" placeholder="E.g. 08-12 345 678" required="" autocomplete="shipping tel" wfd-id="id13">
            </div>
