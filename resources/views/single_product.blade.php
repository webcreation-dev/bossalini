        ...
        <div class="object-cover w-auto md:grid lg:grid-cols-5 xl:grid-cols-3 lg:gap-9 xl:gap-[70px]">
          <div class="xl:col-span-2 lg:col-span-3">
            <div class="grid xl:grid-cols-2 gap-2 flex-auto">
              <div>
                <img class="w-full min-h-[326px]" src="{{asset('files/slider_home01.aea185d6.png')}}"
                  alt="Product title">
              </div>
          ...
          <div
            class="xl:col-span-1 lg:col-span-2 flex flex-col items-center lg:pt-0 md:pt-[70px] pt-11">
            <div class="md:w-[368px]">

              <div class="pt-4 flex-auto justify-center">
                <p class="text-left font-bold md:pt-0 text-[13px] f-700"> BOSSALINI FLY HOODIE </p>
                <p class="pt-2.5 text-left antialiased font-medium text-xs"> CHF 112.00 </p>
              </div>
              <br>
              ...
              <div class="pt-4"><a href="https://bossalini.funcodes.bj/overview"
                  ...
                  <hr style="background-color: #cccccc; height: 2px; border: none;
                  margin: 30px 0;"/>


                <div class="pt-4 flex-auto justify-center">
                    <p class="text-left font-bold md:pt-0 text-[13px] f-700"> PRODUCT DESCRIPTION </p>
                    <p class="pt-2.5 text-left antialiased font-medium text-xs">Overised fit hoodie in a heavyweight
                        jersey cotton. Super soft, pre-shrunk and piece dyed for the ultimate jersey. Ribbed hem & cuffs
                    </p>
