...
<head>
    ...
    <link rel="icon" href="{{asset('files/')}}favicon.png" type="image/x-icon">
            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <img src="{{asset('files/delivery.png')}}" alt="" style="margin-bottom: 30px;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <img src="{{asset('files/success.png')}}" alt="">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <img src="{{asset('files/order-success.png')}}" alt="" style="margin-top: 30px;">
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                        ...
                        @foreach ($order_items as $order_item)
                            <tr>
                                <td valign="top">
                                    <h5 style="margin-top: 15px;">{{App\Models\Product::getNameByProductId($order_item->product_id)}} </h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">{{App\Models\Product::getDescriptionByProductId($order_item->product_id)}} </h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="font-size: 14px; color:#444;margin-top:15px;    margin-bottom: 0px;">Size :
                                        <span> {{$order_item->product_size_id}}</span> </h5>
                                    <h5 style="font-size: 14px; color:#444;margin-top: 10px;">COLOR : <span>{{$order_item->product_color_id}}</span></h5>
                                    <h5 style="font-size: 14px; color:#444;margin-top: 10px;">QTY : <span>{{$order_item->quantity}}</span></h5>
                                </td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="font-size: 14px; color:#444;margin-top:15px"><b>@if (Auth::check()) {{getUserCurrency()}} @else {{getCodeCurrency()}} @endif {{$order_item->total}}</b></h5>
                                </td>
                            </tr>
                        @endforeach
                        ...
                        {{-- <tr>
                            ...
                            <td colspan="3" class="price"
                                ...
                                <b>@if (Auth::check()) {{getUserCurrency()}} @else {{getCodeCurrency()}} @endif 2600.00</b></td>
                        </tr>
                        <tr>
                            <td colspan="2"
                                style="line-height: 49px;font-size: 13px;color: #000000;padding-left: 20px;text-align:left;border-right: unset;">
                            ...
                            <td colspan="3" class="price"
                                style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;">
                                <b>@if (Auth::check()) {{getUserCurrency()}} @else {{getCodeCurrency()}} @endif 10</b></td>
                        </tr>
                        <tr>
                            <td colspan="2"
                            ...
                            <td colspan="3" class="price"
                                style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;">
                                <b>@if (Auth::check()) {{getUserCurrency()}} @else {{getCodeCurrency()}} @endif 2600</b></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" class="price"
                                ...
                                <b>@if (Auth::check()) {{getUserCurrency()}} @else {{getCodeCurrency()}} @endif 30</b></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;
                    ...
                    {{-- <table cellpadding="0" cellspacing="0" border="0" align="left"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="57" height="25" class="user-info"><img src="{{asset('files/space.jpg')}}" alt=" "
        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon" align="center"
                    ...
                    <tr>
                        <td>
                            <a href="#"><img src="{{asset('files/facebook.png')}}" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="{{asset('files/youtube.png')}}" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="{{asset('files/twitter.png')}}" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="{{asset('files/gplus.png')}}" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="{{asset('files/linkedin.png')}}" alt=""></a>
                        </td>
                        <td>
                            <a href="#"><img src="{{asset('files/pinterest.png')}}" alt=""></a>
                        </td>
                    </tr>
                </table>
